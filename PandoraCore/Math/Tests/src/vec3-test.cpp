...
TEST (Vector3Test, adding_two_vectors_adds_the_vectors_by_elements)
{
    ...
    const auto vec_1 = create_random_vector3d ();
    const auto vec_2 = create_random_vector3d ();
...
TEST (Vector3Test, multiplying_two_vectors_multiplies_component_wise)
{
    ...
    const auto left = create_random_vector3d ();
    const auto right = create_random_vector3d ();
    auto res = left * right;
...
TEST (Vector3Test, cross_product_of_two_vector_follows_mathematical_rules)
{
    ...
    const auto vector_1 = create_random_vector3d ();
    const auto vector_2 = create_random_vector3d ();
...
TEST (Vector3Test, multiplying_vector_with_a_vector_multiplies_component_wise)
{
    ...
    const auto vector = create_random_vector3d ();
    const auto other = create_random_vector3d ();
    auto res = vector;
...
TEST (Vector3Test, orthonormal_basis_gives_vectors_of_length_1)
{
    ...
    auto vec1 = create_random_vector3d ();
    auto vec2 = create_random_vector3d ();
    auto vec3 = create_random_vector3d ();
